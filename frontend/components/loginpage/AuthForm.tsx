                ...
                {mode === "otp" ? (
                    <>
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full text-center text-sm text-blue-600 hover:underline disabled:cursor-not-allowed disabled:opacity-50"
                        >
                    ...
                    <>
                        ...
                        <button
                            ...
                            className="flex w-full items-center justify-center gap-3 rounded-xl border-2 border-gray-300 px-6 py-4 font-medium text-gray-700 transition-all duration-150 hover:border-gray-400 hover:bg-gray-50"
                        >
